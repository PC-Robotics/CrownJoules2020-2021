...
public class RedAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Loop and update the dashboard
            telemetry.update();
            encoderDrive(0.05,-2000,-2000,-2000,-2000,10);
        //NOTE WHAT IS BEING WRITTEN RIGHT NOW IS A BLUE AUTO
        //FLIP THE STRAFING FOR RED AUTO
        /*
        sleepRunning(962);
        ...
        if (positionVal > 0) {
            ...
            strafeRight((int) (700 * speedFactor)); //These may not be totally optimized
            ...
            strafeLeft((int) (1100 * speedFactor));
    ...
    public void encoderDrive(double speed,
                             double leftFrontVal, double rightFrontVal, double leftBackVal, double rightBackVal,
                             double timeoutS) {
        ...
        if (opModeIsActive()) {
            ...
            newLeftFrontTarget = robot.leftFront.getCurrentPosition() + (int)(leftFrontVal);
            newRightFrontTarget = robot.rightFront.getCurrentPosition() + (int)(rightFrontVal);
            newLeftBackTarget = robot.leftBack.getCurrentPosition() + (int)(leftBackVal);
            newRightBackTarget = robot.rightBack.getCurrentPosition() + (int)(rightBackVal);
